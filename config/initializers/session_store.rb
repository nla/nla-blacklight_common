Rails.application.config.session_store :active_record_store, key: "_catalogue_session", secure: Rails.env.production? || Rails.env.staging?, httponly: true, samesite: {lax: true}
