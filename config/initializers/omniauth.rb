Rails.application.config.middleware.use OmniAuth::Builder do
  provider :keycloak_openid,
           ...
           client_options: { site: ENV.fetch("KEYCLOAK_URL", "http://localhost:9090"),
                             realm: ENV.fetch("KC_SPL_REALM", "catalogue_spl"),
                             base_url: ENV.fetch("KC_BASE_URL", "/auth") },
  ...
  provider :keycloak_openid,
           ...
           client_options: { site: ENV.fetch("KEYCLOAK_URL", "http://localhost:9090"),
                             realm: ENV.fetch("KC_SOL_REALM", "catalogue_sol"),
                             base_url: ENV.fetch("KC_BASE_URL", "/auth") },
           strategy_class: OmniAuth::Strategies::KeycloakOpenId,
           authorize_params: { scope: "openid" },
           name: "catalogue_sol"
  ...
  provider :keycloak_openid,
           ...
           client_options: { site: ENV.fetch("KEYCLOAK_URL", "http://localhost:9090"),
                             realm: ENV.fetch("KC_SHARED_REALM", "catalogue_shared"),
                             base_url: ENV.fetch("KC_BASE_URL", "/auth") },
           strategy_class: OmniAuth::Strategies::KeycloakOpenId,
           authorize_params: { scope: "openid" },
  ...
  provider :keycloak_openid,
           ...
           client_options: { site: ENV.fetch("KEYCLOAK_URL", "http://localhost:9090"),
                             realm: ENV.fetch("KC_PATRON_REALM", "nla-patron"),
                             base_url: ENV.fetch("KC_BASE_URL", "/auth") },
           strategy_class: OmniAuth::Strategies::KeycloakOpenId,
           authorize_params: { scope: "openid" },
